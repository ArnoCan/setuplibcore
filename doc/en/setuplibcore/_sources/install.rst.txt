...
=========
   ...
   +==============+=============+================================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/setuplibcore      |
   +--------------+-------------+------------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/setuplibcore/ |
   +--------------+-------------+------------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/setuplibcore/       |
   +--------------+-------------+------------------------------------------------+
   | Documents    | sourceforge | https://setuplibcore.sourceforge.io/           |
   +--------------+-------------+------------------------------------------------+
...
For help on extensions to standard options call online context-help:
   ...
   .. parsed-literal::
      ...
      python setup.py **--help-setuplibcore**
